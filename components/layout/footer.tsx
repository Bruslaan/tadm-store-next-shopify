...
export default async function Footer() {
  ...
  return (
    <footer>
      <div className="flex-col px-5 py-16 md:px-10 md:py-20 lg:flex">
        {/* TOP CONTAINER */}
        <div className="lg:flex lg:flex-row lg:justify-between">
          {/* LOGO DIV */}
          <div>
            {/* LOGO */}
            <Image alt="Tadm logo" src="/static/tadm-logo.png" width={60} height={60}></Image>
          ...
          <div className="mt-10 flex flex-col lg:mt-0">
            ...
            {/* ITEM */}
            <div className="mb-4 flex max-w-72 flex-row items-center">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
              ...
              <p className="font-inter ml-4 text-black">info@tadm-nutrition.com</p>
            </div>
          </div>
        </div>
        {/* DIVIDER */}
